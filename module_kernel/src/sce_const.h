...
typedef enum VqmbtInferredBtEventId : unsigned char {
    ...
    VQMBT_SCE_BT_EVENT_UNKNOWN1 = 0x0A,
    VQMBT_SCE_BT_EVENT_UNKNOWN2 = 0x0C,
    VQMBT_SCE_BT_EVENT_BUTTON_PRESSED = 0x0D,
    VQMBT_SCE_BT_EVENT_UNKNOWN3 = 0x0E,
    VQMBT_SCE_BT_EVENT_UNKNOWN4 = 0x10,
    VQMBT_SCE_BT_EVENT_UNKNOWN5 = 0x11,
    VQMBT_SCE_BT_EVENT_TOGGLE_BLUETOOTH = 0x15,
    VQMBT_SCE_BT_EVENT_UNKNOWN6 = 0x1C,
